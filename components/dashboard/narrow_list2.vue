<template>
    <div class="flex flex-col rounded-md bg-white rouended-md w-full shadow-md" style="word-wrap: break-word;">
        <div class="flex justify-between items-center p-6">
            ...
            <nuxt-link to="/user/questions/addProject" v-else class="flex justify-center items-center  text-white font-bold p-2 rounded focus:outline-none focus:shadow-outline" style="box-shadow: 5px 5px 14px -6px rgba(23,198,152,0.9);backgroundColor:#17C69B;">
                ثبت پروژه
