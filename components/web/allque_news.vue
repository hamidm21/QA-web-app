                                    ...
                                    <tr v-for="item in items" v-bind:key="item.id" >
                                        <td class="p-4">
                                            <div class="flex justify-start items-center">
                                                <div v-bind:class="item['state_name'] === 'is_active' ? 'bg-primary' : item['state_name'] === 'is_finished' ? 'bg-gray-700' : item['state_name'] === 'wait_for_response' ? 'bg-green' : item['state_name'] === 'question_solved_request' ? 'bg-green' : 'bg-gray-700' " class="w-5 h-5 rounded-full p-2"/>
