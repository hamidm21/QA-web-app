<template>
  <div class="app-sec bg-white flex items-center justify-center">
    <div class="mx-auto max-w-6xl px-6 py-12" style="width: inherit">
      <div
        class="flex flex-col md:flex-row shadow justify-center rounded"
      ...
      >
        <div class="xl:w-1/2 max-w-md my-5 mx-5 flex flex-col justify-center">
          ...
          <p class="text-xl text-base text-black mt-4 hidden sm:block">
            حل یاب به شما کمک میکند تا از حرفه و شغل تخصصی تان لذت ببرید و
            درآمدتان را بهتر کنید.
          </p>
        </div>
        <div
          class="md:w-1/2 flex justify-start my-5 md:justify-end w-full md:w-1/2"
        >
          <form
            class="rounded flex-auto max-w-sm bg-gray-100 p-10 pb-20 shadow-2xl"
          >
            <div class="w-full">
              <div
                class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"
              >
                <span class="text-red-400 mr-1">*</span> نام شما
              </div>
              <div
                class="my-2 bg-white p-1 flex border border-gray-200 rounded"
              >
                <input
                  placeholder="نام"
                  v-model="name"
            ...
            <div class="w-full">
              <div
                class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"
              >
                <span class="text-red-400 mr-1">*</span> مدرک شما
              </div>
              <div
                class="my-2 bg-white p-1 flex border border-gray-200 rounded"
              >
            ...
            <div class="w-full">
              <div
                class="font-bold h-6 mt-3 text-gray-600 text-xs leading-8 uppercase"
              >
                <span class="text-red-400 mr-1">*</span> ایمیل شما
              </div>
              <div
                class="my-2 bg-white p-1 flex border border-gray-200 rounded"
              >
            ...
            <div class="mt-6 relative">
              <div
                @click="send()"
                class="shadow-md font-medium py-2 px-4 text-green-100 text-white text-bold text-2xl cursor-pointer bg-blue-600 rounded text-lg tr-mt text-center w-full"
              >
                ارسال
              </div>
            </div>
  ...
  methods: {
    ...
    send() {
      ...
      let obj = {
        ...
        degree: this.degree
          ? this.degree
          : errors.push("مدرک خود را وارد کنید"),
        email: this.email ? this.email : errors.push("ایمیل خود را وارد کنید"),
        pic: this.$store.state.question.add.Files[0]
