                                                    ...
                                                    <div v-show="ddOpen === 2" class="absolute shadow-md top-100 z-40 w-full lef-0 rounded max-h-select overflow-y-auto">
                                                        <div class="flex flex-col w-full">
                                                            <div @click="dd2Handler(item);" v-for="item in dd2" v-bind:key="item.id" class="cursor-pointer w-full border-gray-100 border-b hover:bg-teal-100">
                                                                <div class="flex w-full items-center p-2 pl-2 border-transparent bg-white border-l-2 relative hover:bg-primary hover:text-teal-100" v-bind:class="dd2Selected === item ? 'border-primary': ''">
                                                                    <div class="w-full items-center flex">
                                                                        <div class="mx-2 leading-6  "> {{item.name}} </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div v-show="ddOpen === 3" class="absolute shadow-md top-100 z-40 w-full lef-0 rounded max-h-select overflow-y-auto">
                                                    <div class="flex flex-col w-full">
                                                        <div @click="dd3Handler(item)" v-for="item in dd3" v-bind:key="item.id" class="cursor-pointer w-full border-gray-100 border-b hover:bg-teal-100">
                                                            <div class="flex w-full items-center p-2 pl-2 border-transparent bg-white border-l-2 relative hover:bg-primary hover:text-teal-100" v-bind:class="dd3Selected === item ? 'border-primary': ''">
                                                                <div class="w-full items-center flex">
                                                                    <div class="mx-2 leading-6  "> {{item.name}} </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="flex-col items-center">
                                                ...
                                                <div class="flex flex-col items-center relative">
                                                    ...
                                                    <div v-show="ddOpen === 4" class="absolute shadow-md top-100 z-40 w-full lef-0 rounded max-h-select overflow-y-auto">
                                                        <div class="flex flex-col w-full">
                                                            <div @click="dd4Selected = item; opener(0)" v-for="item in dd4" v-bind:key="item.id" class="cursor-pointer w-full border-gray-100 border-b hover:bg-teal-100">
                                                                <div class="flex w-full items-center p-2 pl-2 border-transparent bg-white border-l-2 relative hover:bg-primary hover:text-teal-100" v-bind:class="dd4Selected === item ? 'border-primary': ''">
                                                                    <div class="w-full items-center flex">
                                                                        <div class="mx-2 leading-6  "> {{item.name}} </div>
                                                                    </div>
                                                                </div>
...
export default {
    ...
    methods: {
        opener(id) {
            ...
            } else if (id === 4 && !this.dd2Selected.category_less && this.dd3Selected === '') {
                this.$toast.info(" ابتدا رشته تحصیلی را انتخاب کنید ")
            } else if (id === 4 && this.dd2Selected.category_less && this.dd2Selected === '') {
                this.$toast.info(" ابتدا مقطع تحصیلی را انتخاب کنید ")
            } else {
        ...
        dd2Handler(item) {
            ...
            if (!item.category_less) {
                ...
                this.dd4 = this.catless.filter(catless => catless.grades.some(isInCat))
            }
        },
        dd3Handler(item) {
            this.dd4Selected = '';
