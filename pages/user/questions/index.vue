    ...
    <div class="w-full sm:p-10">
      ...
      >
            ...
            <table class="w-full">
              <thead v-show="items.length !== 0" class="w-full">
                <tr class="w-full border-b">
                  ...
                  <th class="pb-2">نام پروژه</th>

                  <th class="pb-2">مقطع</th>
                  <th class="pb-2">مهلت</th>
                  <th class="pb-2">سقف هزینه</th>
                  <th class="pb-2">پیشنهاد</th>
                </tr>
              </thead>
              ...
              <tbody v-else class="w-full">
                <div
                  class="w-full flex flex-col justify-center items-center p-32"
                >
                  <img
                    class="w-20"
        ...
        <div v-if="pagination.pages > 1" id="paginator" class="m-2">
          <Pagination
            v-bind:ps="pagination.pages"
            v-bind:p="pagination.page"
...
export default {
  ...
  async asyncData({ $axios, $auth }) {
    ...
    const items = s_res.data.results.filter(
      (x) => x.owner === $auth.user.username
    );
    return {
      items,
      pagination: {
