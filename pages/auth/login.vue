  ...
  <div class="login w-full sm:w-auto">
        ...
        <form @keydown.enter="authLogin()" class="bg-white shadow-lg rounded-lg flex w-max-md justify-center m-4 border">
            <div class="px-8 pt-6 mb-4">
              ...
              <button @click="authLogin" type="button" class=" hover:bg-blue-700 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline" style="box-shadow: 0 4px 14px 0 rgba(0,118,255,0.39);backgroundColor:#4c7fa7">
                  ورود
              </button>
              </div>
